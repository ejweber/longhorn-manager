...
func (c *BackingImageDataSourceController) prepareRunningParameters(bids *longhorn.BackingImageDataSource) error {
	...
	if newSnapshotRequired {
		freezeFS, err := c.ds.GetFreezeFSForSnapshotSettingForEngine(e)
		if err != nil {
			return err
		}
		...
		snapshotName, err := engineClientProxy.SnapshotCreate(e, bids.Name+"-"+util.RandomID(), snapLabels, freezeFS)
		if err != nil {
			return err
		}
